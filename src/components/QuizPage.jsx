...
const QuizPage = () => {
  ...
  return (
    <div className="quiz-container">
      ...
      {/* Question 1 */}
      <p>Question 1: How satisfied are you with your current financial situation?</p>
      ...
      {/* Question 2 */}
      <p>Question 2: How confident are you in your financial planning skills?</p>
      <div className="radio-container">
        {["1", "2", "3", "4", "5"].map((value) => (
          <label key={value} className="radio-label">
            <input
      ...
      {/* Question 3 */}
      <p>Question 3: How often do you review your financial goals?</p>
      <div className="radio-container">
        {["1", "2", "3", "4", "5"].map((value) => (
          <label key={value} className="radio-label">
            <input
      ...
      {/* Question 4 */}
      <p>Question 4: How important is it for you to save for retirement?</p>
      <div className="radio-container">
        {["1", "2", "3", "4", "5"].map((value) => (
          <label key={value} className="radio-label">
            <input
